declare namespace NodeJS {
  interface ProcessEnv {
    ...
    DEV: boolean | undefined    // Code runs in development mode
    PROD: boolean | undefined   // Code runs in production mode
    CLIENT: boolean | undefined // Code runs on client (not on server)
    SERVER: boolean | undefined // Code runs on server (not on client)
